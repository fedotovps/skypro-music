...
export const Player = () => {
  ...
  const { isLiked, handleLike } = currentTrack ? useLikeTrack(currentTrack) : { isLiked: false, handleLike: () => {} };
        ...
        <div className={styles.bar__player_block}>
          <div className={styles.bar__player}>
            <div className={styles.player__controls}>
              ...
              <div
                className={clsx(styles.player__btn_repeat, styles._btn_icon)}
              >
                <svg
                  onClick={toggleLoop}
                  className={clsx(
              ...
              <div
                className={clsx(styles.player__btn_shuffle, styles._btn_icon)}
              >
                <svg
            ...
            <div className={clsx(styles.player__track_play, styles.track_play)}>
              ...
              <div className={styles.track_play__like_dis}>
                ...
                >
                  <svg className={styles.track_play__like_svg} onClick={handleLike}>
